...
用法:
  python -m guidance_rl.eval.eval_gym --policy png                      # PNG 基线
  python -m guidance_rl.eval.eval_gym --policy checkpoints/bc_policy.pt
  python -m guidance_rl.eval.eval_gym --policy checkpoints/rl_policy.pt \\
